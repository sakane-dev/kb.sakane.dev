    ...
    <div className='bg-background text-on-surface font-body selection:bg-primary/30 min-h-screen flex dark'>
      ...
      <aside className='hidden md:flex flex-col h-screen w-64 fixed left-0 top-0 bg-[#1b1c1e] z-50 border-r border-[#343537]/15'>
        <div className='p-8'>
          ...
          <div className='text-[10px] uppercase tracking-widest text-outline font-label'>
        ...
        <div className='mt-4 flex-1'>
          <nav className='space-y-1'>
            <Link
              href='/'
              className='text-[#c2c1ff] font-semibold border-r-2 border-[#c2c1ff] bg-[#292a2c]/50 px-6 py-3 flex items-center gap-3 transition-colors duration-200'
            >
        ...
        <div className='p-6 border-t border-outline-variant/10'>
          <div className='flex items-center gap-3 mb-6'>
            <div>
              ...
              <div className='text-[10px] uppercase text-outline tracking-tighter'>
                Researcher
              </div>
            </div>
          </div>
